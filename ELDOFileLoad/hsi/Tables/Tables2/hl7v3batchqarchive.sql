CREATE TABLE [hsi].[hl7v3batchqarchive] (
    [hl7v3bqarchivenum]      BIGINT     NOT NULL,
...
GO
CREATE UNIQUE NONCLUSTERED INDEX [hl7v3batchqarchive1]
    ON [hsi].[hl7v3batchqarchive]([hl7v3bqarchivenum] ASC);
