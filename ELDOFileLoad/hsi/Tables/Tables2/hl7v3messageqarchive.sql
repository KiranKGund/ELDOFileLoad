CREATE TABLE [hsi].[hl7v3messageqarchive] (
    [hl7v3mqarchivenum]       BIGINT     NOT NULL,
...
GO
CREATE UNIQUE NONCLUSTERED INDEX [hl7v3messageqarchive1]
    ON [hsi].[hl7v3messageqarchive]([hl7v3mqarchivenum] ASC);
