CREATE TABLE [dbo].[ELDOPENDCLMSHEADER] (
    ...
    [LOAD_DATE]                      DATE            CONSTRAINT [ELDOPENDCLMSHEADER_LOAD_DATE] DEFAULT (getdate()) NULL,
    ...
    CONSTRAINT [CC1110258041358] PRIMARY KEY CLUSTERED ([POLICY_UNDERWRITER] ASC, [GROUP_NUMBER] ASC, [CLAIM_NUMBER] ASC)
);


GO
CREATE NONCLUSTERED INDEX [ELDOCLHDREMPSSNSEQ]
    ON [dbo].[ELDOPENDCLMSHEADER]([EMPLOYEE_SSN] ASC, [DEPENDENT_SEQUENCE_NUMBER] ASC);


GO
CREATE NONCLUSTERED INDEX [ELDOCLHDRPNDRSCODE]
    ON [dbo].[ELDOPENDCLMSHEADER]([PENDED_REASON_CODE] ASC);


GO
CREATE NONCLUSTERED INDEX [ELDOPENDCLMHDRTIFF]
    ON [dbo].[ELDOPENDCLMSHEADER]([TIFF_IMAGE_IDENTIFIER] ASC);


GO
CREATE NONCLUSTERED INDEX [ELDOPENDCLMPOLGRP]
    ON [dbo].[ELDOPENDCLMSHEADER]([POLICY_UNDERWRITER] ASC, [GROUP_NUMBER] ASC);


GO
CREATE NONCLUSTERED INDEX [ELDOPENDCLMSCLMNO]
    ON [dbo].[ELDOPENDCLMSHEADER]([CLAIM_NUMBER] ASC);


GO
CREATE NONCLUSTERED INDEX [ELDOPENDCLMSHDRADJ]
    ON [dbo].[ELDOPENDCLMSHEADER]([POLICY_UNDERWRITER] ASC, [GROUP_NUMBER] ASC, [CLAIM_NUMBER] ASC, [CLAIM_STATUS] ASC, [NET_PAYMENT_AMOUNT_1] ASC, [NET_PAYMENT_AMOUNT_2] ASC, [NET_PAYMENT_AMOUNT_3] ASC, [NET_PAYMENT_AMOUNT_4] ASC, [NET_PAYMENT_AMOUNT_5] ASC, [CLAIM_NUMBERING_CONNECTION_2] ASC);


GO
CREATE NONCLUSTERED INDEX [ELDOPENDEMPSSN]
    ON [dbo].[ELDOPENDCLMSHEADER]([EMPLOYEE_SSN] ASC);


GO
CREATE NONCLUSTERED INDEX [ELDOPENDHOLD]
    ON [dbo].[ELDOPENDCLMSHEADER]([HOLD_CLAIM_FROM_PAYMENT] ASC);


GO
CREATE NONCLUSTERED INDEX [ELDOPENDMCSNO]
    ON [dbo].[ELDOPENDCLMSHEADER]([MCS_CLAIM_NUMBER] ASC);


GO
CREATE NONCLUSTERED INDEX [ELDOPENDPROVID]
    ON [dbo].[ELDOPENDCLMSHEADER]([PROVIDER_TAX_ID_1] ASC);


GO
CREATE NONCLUSTERED INDEX [ELDOPNDCLMSHDFRMTP]
    ON [dbo].[ELDOPENDCLMSHEADER]([FORM_TYPE] ASC);


GO
CREATE NONCLUSTERED INDEX [ELDOPNDSNPVAMTDS]
    ON [dbo].[ELDOPENDCLMSHEADER]([EMPLOYEE_SSN] ASC, [PROVIDER_TAX_ID_1] ASC, [TOTAL_CHARGE_AMOUNT] ASC, [INCURRED_DATE] ASC);
