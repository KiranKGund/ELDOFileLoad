CREATE TABLE [dbo].[ELDOCLMSHEADER] (
    ...
    [FILLER_5]                       VARCHAR (56)    NULL,
    [FILLER_4]                       VARCHAR (200)   NULL,
    [FILLER_3]                       VARCHAR (200)   NULL,
    [FILLER_2]                       VARCHAR (100)   NULL,
    [FILLER]                         VARCHAR (200)   NULL,
    [COPAY_EXCEPTION_AMOUNT_1]       DECIMAL (12, 2) NULL,
    [COPAY_EXCEPTION_AMOUNT_2]       DECIMAL (12, 2) NULL,
    [COPAY_EXCEPTION_APPLIESTO_2]    CHAR (1)        NULL,
    [COPAY_EXCEPTION_AMOUNT_3]       DECIMAL (12, 2) NULL,
    [COPAY_EXCEPTION_APPLIESTO_3]    CHAR (1)        NULL,
    [COPAY_EXCEPTION_AMOUNT_4]       DECIMAL (12, 2) NULL,
    [COPAY_EXCEPTION_APPLIESTO_4]    CHAR (1)        NULL,
    [COPAY_EXCEPTION_AMOUNT_5]       DECIMAL (12, 2) NULL,
    [COPAY_EXCEPTION_APPLIESTO_5]    CHAR (1)        NULL,
    [COPAY_EXCEPTION_AMOUNT_6]       DECIMAL (12, 2) NULL,
    [COPAY_EXCEPTION_APPLIESTO_6]    CHAR (1)        NULL,
    [COPAY_EXCEPTION_AMOUNT_7]       DECIMAL (12, 2) NULL,
    [COPAY_EXCEPTION_APPLIESTO_7]    CHAR (1)        NULL,
    [COPAY_EXCEPTION_AMOUNT_8]       DECIMAL (12, 2) NULL,
    [COPAY_EXCEPTION_APPLIESTO_8]    CHAR (1)        NULL,
    ...
    CONSTRAINT [CC1110246366976] PRIMARY KEY NONCLUSTERED ([POLICY_UNDERWRITER] ASC, [GROUP_NUMBER] ASC, [CLAIM_NUMBER] ASC, [EMPLOYEE_SSN] ASC, [DEPENDENT_SEQUENCE_NUMBER] ASC)
);


GO
CREATE CLUSTERED INDEX [IDX608042044590000]
    ON [dbo].[ELDOCLMSHEADER]([PAID_DATE] ASC, [EMPLOYEE_SSN] ASC, [PROVIDER_TAX_ID_1] ASC, [CLAIM_NUMBER] ASC, [GROUP_NUMBER] ASC, [POLICY_UNDERWRITER] ASC);


GO
CREATE NONCLUSTERED INDEX [ELDOCHDRPROVID]
    ON [dbo].[ELDOCLMSHEADER]([PROVIDER_TAX_ID_1] ASC);


GO
CREATE NONCLUSTERED INDEX [ELDOCLHDRPOLGRCLM]
    ON [dbo].[ELDOCLMSHEADER]([POLICY_UNDERWRITER] ASC, [GROUP_NUMBER] ASC, [CLAIM_NUMBER] ASC);


GO
CREATE NONCLUSTERED INDEX [ELDOCLMDHDPDDATE]
    ON [dbo].[ELDOCLMSHEADER]([PAID_DATE] ASC);


GO
CREATE NONCLUSTERED INDEX [ELDOCLMSHDR_TIFF]
    ON [dbo].[ELDOCLMSHEADER]([TIFF_IMAGE_IDENTIFIER] ASC);


GO
CREATE NONCLUSTERED INDEX [ELDOCLMSHDRPOLGRP]
    ON [dbo].[ELDOCLMSHEADER]([POLICY_UNDERWRITER] ASC, [GROUP_NUMBER] ASC);


GO
CREATE NONCLUSTERED INDEX [ELDOCLMSHEADERADJ]
    ON [dbo].[ELDOCLMSHEADER]([POLICY_UNDERWRITER] ASC, [GROUP_NUMBER] ASC, [CLAIM_NUMBER] ASC, [CLAIM_STATUS] ASC, [NET_PAYMENT_AMOUNT_1] ASC, [NET_PAYMENT_AMOUNT_2] ASC, [NET_PAYMENT_AMOUNT_3] ASC, [NET_PAYMENT_AMOUNT_4] ASC, [NET_PAYMENT_AMOUNT_5] ASC, [CLAIM_NUMBERING_CONNECTION_2] ASC);


GO
CREATE NONCLUSTERED INDEX [ELDOHDRCLMSRECDUSR]
    ON [dbo].[ELDOCLMSHEADER]([INPUT_BY] ASC, [RECEIVED_DATE] ASC);


GO
CREATE NONCLUSTERED INDEX [ELDOHDRLOADDATE]
    ON [dbo].[ELDOCLMSHEADER]([LOAD_DATE] ASC);


GO
CREATE NONCLUSTERED INDEX [ELDOHDRMCSCLAIM]
    ON [dbo].[ELDOCLMSHEADER]([MCS_CLAIM_NUMBER] ASC);


GO
CREATE NONCLUSTERED INDEX [ELDOHDRPDDATE]
    ON [dbo].[ELDOCLMSHEADER]([INPUT_DATE] ASC);


GO
CREATE NONCLUSTERED INDEX [ELDOHDRPLAN]
    ON [dbo].[ELDOCLMSHEADER]([PLAN_CODE_USED] ASC);


GO
CREATE NONCLUSTERED INDEX [ELDOKEYTOPROVFILE1]
    ON [dbo].[ELDOCLMSHEADER]([KEY_TO_PROVIDER_FILE_1] ASC);


GO
CREATE NONCLUSTERED INDEX [ELDOPDCLMCLAIMNO]
    ON [dbo].[ELDOCLMSHEADER]([CLAIM_NUMBER] ASC);


GO
CREATE NONCLUSTERED INDEX [ELDOPDCLMSSN]
    ON [dbo].[ELDOCLMSHEADER]([EMPLOYEE_SSN] ASC);


GO
CREATE NONCLUSTERED INDEX [IDX506071555030000]
    ON [dbo].[ELDOCLMSHEADER]([PAID_DATE] ASC, [CLAIM_NUMBER] ASC, [GROUP_NUMBER] ASC, [POLICY_UNDERWRITER] ASC);


GO
CREATE NONCLUSTERED INDEX [IDX506071556200000]
    ON [dbo].[ELDOCLMSHEADER]([PAID_DATE] ASC, [TOTAL_CHARGE_AMOUNT] ASC, [CHECK_NUMBER_USED_1] ASC, [KEY_TO_PROVIDER_FILE_1] ASC, [PROCESSED_DATE] ASC, [CLAIM_STATUS] ASC, [RELATIONSHIP_TO_EMPLOYEE] ASC, [DEPENDENT_SEQUENCE_NUMBER] ASC, [EMPLOYEE_SSN] ASC, [CLAIM_NUMBER] ASC, [GROUP_NUMBER] ASC, [POLICY_UNDERWRITER] ASC);


GO
CREATE NONCLUSTERED INDEX [IDX708291513410000]
    ON [dbo].[ELDOCLMSHEADER]([GROUP_NUMBER] ASC, [POLICY_UNDERWRITER] ASC, [PAID_DATE] ASC, [TOTAL_CLAIM_PAID] ASC, [CLAIM_NUMBER] ASC, [PLAN_CODE_USED] ASC, [DEPENDENT_SEQUENCE_NUMBER] ASC, [EMPLOYEE_SSN] ASC);
