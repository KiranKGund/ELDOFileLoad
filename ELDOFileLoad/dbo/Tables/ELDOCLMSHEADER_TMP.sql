CREATE TABLE [dbo].[ELDOCLMSHEADER_TMP] (
    ...
    CONSTRAINT [CC1110246366976_TMP] PRIMARY KEY NONCLUSTERED ([POLICY_UNDERWRITER] ASC, [GROUP_NUMBER] ASC, [CLAIM_NUMBER] ASC, [EMPLOYEE_SSN] ASC, [DEPENDENT_SEQUENCE_NUMBER] ASC)
);
