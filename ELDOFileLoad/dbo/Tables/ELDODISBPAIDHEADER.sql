CREATE TABLE [dbo].[ELDODISBPAIDHEADER] (
    ...
    [LOAD_DATE]                    DATE            CONSTRAINT [ELDODISBPAIDHEADER_LOAD_DATE] DEFAULT (getdate()) NOT NULL,
    ...
    CONSTRAINT [CC1354198498208] PRIMARY KEY CLUSTERED ([POLICY_UNDERWRITER] ASC, [GROUP_NUMBER] ASC, [CLAIM_NUMBER] ASC, [EMPLOYEE_SSN] ASC, [DEPENDENT_SEQUENCE_NUMBER] ASC)
);


GO
CREATE NONCLUSTERED INDEX [IDX_PAID_DATE]
    ON [dbo].[ELDODISBPAIDHEADER]([PAID_DATE] ASC);
